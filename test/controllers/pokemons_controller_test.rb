...
class PokemonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post pokemons_url, params: { pokemon: { altura: @pokemon.altura, nome: @pokemon.nome, peso: @pokemon.peso } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { altura: @pokemon.altura, nome: @pokemon.nome, peso: @pokemon.peso } }
